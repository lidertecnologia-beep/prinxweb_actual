...
const ActividadesSolicitud = ({ actividades }) => {
  const [listActividadesSolicitud, setListActividadesSolicitud] = useState([{}])

  useEffect(() => {
    if (actividades) setListActividadesSolicitud(actividades)
  }, [actividades])

  return (

    <DataTable
      value={listActividadesSolicitud}
      paginator
...
export default ActividadesSolicitud
